...
define(['shipShape', 'rotationTranslator'], function(shipShape, rotationTranslator) {
  var ShipState;
  return ShipState = (function() {
    ...
    function ShipState(settings) {
      ...
      this.rotatedPoints = __bind(this.rotatedPoints, this);
    ...
    ShipState.prototype.rotatedPoints = function() {
